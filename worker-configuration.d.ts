/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c3ef66a82a4090df1aaedd10a647c0b)
// Runtime types generated with workerd@1.20260815.1 2026-08-04 
interface __BaseEnv_Env {
	DB: D1Database;
	roomids: [418,540,501,502,503,504,505];
	webpushKey: string;
	Elec: Workflow<Parameters<import("./src/workers").Elec['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "roomids" | "webpushKey">> {}
}
